...
table_coast = store[goods['Стол']][0]['quantity'] * store[goods['Стол']][0]['price'] +\
...
sofa_coast = store[goods['Диван']][0]['quantity'] * store[goods['Диван']][0]['price'] +\
...
chair_coast = store[goods['Стул']][0]['quantity'] * store[goods['Стул']][0]['price'] +\
...
print('Диван -', sofa_quantity, 'шт, стоимость', sofa_coast, 'руб')
print('Стул -', chair_quantity, 'шт, стоимость', chair_coast, 'руб')
##########################################################################################
